...
export default function Work() {
  ...
  const mySchoolImg = require("../../assets/images/Myschool.jpeg");
        ...
        <div className="projects-content Owl-project">
          <div className="card">
            <div className="box">
              ...
              >
                <img src={mySchoolImg} alt="Code-Quiz projects" class="quiz" />
                <div className="project-title">My-School</div>
                <div className="textBox5">
                  <p className="wrap">
                    {" "}
                    All in one place for better communication between parents,
                ...
                <Popup trigger={isShown5}>
                  <div className="banner ">
                    <div className="bold">My-School</div>
                    <div>---------</div>
                  ...
                  <div className="buttonLink">
                    ...
                    <a
                      href="https://github.com/Chrisolsen1993/My-School"
                      target="_blank"
                    >
                      {" "}
                      <button className="button-area" type="button">
                        Github Code
                      </button>
                    </a>
                  </div>
            ...
            <div className="box">
              ...
              >
                ...
                <div className="textBox1 textBox11">
                  <p>
                    {" "}
                    Look up a job by tech industry and experience level that
                    best suit your skillset
                  </p>
                </div>
                <Popup trigger={isShown1}>
                  <div className="popJob">
                    ...
                    <div className="buttonLink">
                      <a
                        href="https://matthewjflanagan.github.io/JOBS-4-MORE/"
                        target="_blank"
                      >
                        {" "}
                        <button className="button-area button1" type="button">
                      ...
                      <a
                        href="https://github.com/Chrisolsen1993/JOBS-4-MORE"
                        target="_blank"
                      >
                        {" "}
                        <button className="button-area" type="button">
            ...
            <div className="box">
              ...
              >
                ...
                <div className="textBox2">
                  <p>
                    {" "}
                    Peer-to-peer bulk recycling network, facilitating the
            ...
            <div className="box">
              ...
              >
                ...
                <div className="textBox1 textBox12">
                  <p className="wrap">
                    {" "}
                    An app that allow a user to make a post regarding any Tech
                    subject.
                  </p>
                </div>
                <Popup trigger={isShown3}>
                  ...
                  <div className="buttonLink">
                    <a
                      href="https://frozen-brook-84861.herokuapp.com/"
                      target="_blank"
                    >
                      {" "}
                      <button className="button-area button1" type="button">
                    ...
                    <a
                      href="https://github.com/Chrisolsen1993/Tech-Blog"
                      target="_blank"
                    >
                      {" "}
                      <button className="button-area button2" type="button">
                        Github Code
                      </button>
                    </a>
                  </div>
            ...
            <div className="box">
              ...
              >
                ...
                <div className="textBox5">
                  <p>
                    {" "}
                    One-stop shop where users swap their used or unused toys
                    with other users.{" "}
                  </p>
                </div>
            ...
            <div className="box">
              ...
              >
                ...
                <Popup trigger={isShown}>
                  ...
                  <div className="buttonLink">
                    <a
                      href="https://chrisolsen1993.github.io/Work-Day-Scheduler/"
                      target="_blank"
                    >
                      {" "}
                      <button className="button-area button1" type="button">
                    ...
                    <a
                      href="https://github.com/Chrisolsen1993/Work-Day-Scheduler"
                      target="_blank"
                    >
                      {" "}
                      <button className="button-area" type="button">
